  ...
  return (
    <div className="flex flex-col min-h-screen">
      <section className="relative w-full h-[80vh] bg-black">
        ...
        <Image
          className="w-full h-full object-cover object-top z-0 absolute top-0 left-0"
          src={HeroImage}
          alt=""
        />
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-xl">
            Premium barbershop experience with skilled professionals and
            exceptional service
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/2 mb-8 md:mb-0">
              <div className="rounded-lg overflow-hidden h-[500px] bg-zinc-200">
                <Image
                  src={AboutImage}
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-zinc-600 mb-6">
                Founded in 2010, Prime Cuts has been providing premium grooming
                services to gentlemen who appreciate quality and style. Our team
                of skilled barbers combines traditional techniques with modern
